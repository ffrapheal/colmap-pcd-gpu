...
[NSH Atrium Indoor Dataset](https://drive.google.com/drive/folders/1V8eIvS2JGguZAIaR0orf0Hxbstpoy5Xx?usp=sharing): Registration of 450 images in the figure below.

<p align="center">
  <img src="img/nsh_atrium_indoor_dataset.jpg" alt="Example Dataset" width="70%"/>
</p>

[NSH Patio Outdoor Dataset](https://drive.google.com/drive/folders/16VypPnqFqx67-8dSSilUIHH_pGJbrNif?usp=sharing): Registration of 450 images in the figure below. To improve initialization robustness, click 'Reconstruction->Reconstruction options', in the 'Init' tab, set 'init_image_id2 = 2'.

<p align="center">
  <img src="img/nsh_patio_outdoor_dataset.jpg" alt="Example Dataset" width="70%"/>
</p>

[Smith Hall Outdoor Dataset](https://drive.google.com/drive/folders/1q36VNymOGUJAitQkk2PmzFwgXtcKhPfq?usp=sharing): Registration of 25 images in the [instruction video](https://youtu.be/TuX8tCmJCC8), and registration of 450 images in the figure below.
